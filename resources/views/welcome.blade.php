...
<header class="page-header">
    <div class="background-image-holder parallax-background">
        <img class="background-image" alt="Background Image" src="{{ asset('assets/img/dog1.jpg') }}">
    </div>
...
<section>
    <div class="container">
        ...
        <hr>
        @if (count($items) == 0)
            <h1 class="text-center text-primary">No Animal have been posted at this time!</h1>
        @else
            <h1 class="text-center">Recently Placed Animal</h1>
            <hr>
            <div class="row">
